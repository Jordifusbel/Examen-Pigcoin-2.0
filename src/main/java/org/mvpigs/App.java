...
//         */
        ...
        trx = new Transaction("hash_4", "2", origin.getAddress(), wallet_1.getAddress(), 20.0, "sausages puagh!");
        bChain.addOrigin(trx);
        trx = new Transaction("hash_5", "3", origin.getAddress(), wallet_1.getAddress(), 10.0, "baked beans are off!");
        bChain.addOrigin(trx);
